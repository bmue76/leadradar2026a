...
export default function LeadsClient() {
  ...
  const buildListQuery = useCallback(
    ...
    [formId, includeDeleted, fromDate, toDate, limit]
  );
      ...
      <div className="mb-4 rounded-xl border bg-white p-4">
        ...
        {formsState === "error" && (
          <div className="mt-3 rounded-lg border border-red-200 bg-red-50 p-3 text-sm">
            <div className="font-medium text-red-800">Could not load forms.</div>
            <div className="mt-1 text-red-800/80">Filter dropdown may be incomplete.</div>

...
- PROJECT_HINTS.md — Verbindliche Kurz-Leitplanken
...
- TP 6.8 — Mobile Branding Refresh (TTL + Focus Revalidate + Logo Versioning) → ../teilprojekt-6.8-mobile-branding-refresh-ttl-focus.md

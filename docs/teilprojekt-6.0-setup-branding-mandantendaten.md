...
Branch: main  
Commit(s):
- a327554 — feat(tp6.0): tenant profile + branding + topbar
- 6c5b8db — docs(tp6.0): schlussrapport branding + index
...
- Logo Upload MVP (PNG/SVG) über bestehenden Endpoint /api/admin/v1/tenants/current/logo (Preview/Cache-bust via query param).
